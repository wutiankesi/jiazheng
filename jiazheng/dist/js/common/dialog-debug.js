(function($, window, QNR) {
    ...
    var _isIE = !!$.browser.msie, _isIE6 = _isIE && $.browser.version === "6.0", $doc = $(window.document), $body = $("body"), $win = $(window);
    ...
    if (typeof define === "function") {
        define("js/common/dialog-debug", [], function(require, exports, module) {
