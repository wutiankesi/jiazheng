define("js/list/list-debug", [ "jquery-debug", "../common/page-debug", "../common/CD-debug", "../common/header-debug", "../common/map-debug" ], function(require, exports, module) {
    var $ = require("jquery-debug");
    var pager = require("../common/page-debug");
...
define("js/common/page-debug", [ "jquery-debug", "js/common/CD-debug" ], function(require, exports, module) {
    var $ = require("jquery-debug");
    var ifs = require("js/common/CD-debug");
    function create(pagger) {
        ...
        var pages = [];
        var gap = "...";
        var rs = [], ls = [], lv, rv, maxed = false, mined = false;
        lv = rv = now;
        if (1 == max) {
            return [ 1 ];
        }
