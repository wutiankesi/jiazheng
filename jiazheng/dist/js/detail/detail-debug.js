define("js/detail/detail-debug", [ "jquery-debug", "../common/header-debug", "../common/jquery.flexslider-debug", "../common/CD-debug", "../common/util-debug", "../common/dialog-debug", "./dianping-debug", "../common/map-debug" ], function(require, exports, module) {
    var $ = require("jquery-debug");
    var header = require("../common/header-debug");
    var ss = require("../common/jquery.flexslider-debug");
    var CD = require("../common/CD-debug");
    var util = require("../common/util-debug");
    var dianping = require("./dianping-debug");
    var map_module = require("../common/map-debug");
    function initSlider() {
        var dom = $("#slider");
        var size = {
            width: 200,
...
(function($) {
    ...
    if (typeof define !== "undefined") {
        define("js/common/jquery.flexslider-debug", [], function(require, exports, modules) {
...
define("js/detail/dianping-debug", [ "jquery-debug", "js/common/util-debug", "js/common/dialog-debug", "js/common/CD-debug" ], function(require, exports, module) {
    var $ = require("jquery-debug");
    var util = require("js/common/util-debug");
    function initDp() {
...
define("js/common/map-debug", [ "js/common/CD-debug", "jquery-debug" ], function(require, exports, module) {
