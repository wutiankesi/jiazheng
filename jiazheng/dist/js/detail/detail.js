define("js/detail/detail", [ "jquery", "../common/header", "../common/jquery.flexslider", "../common/CD", "../common/util", "../common/dialog", "./dianping", "../common/map" ], function(require, exports, module) {
    var $ = require("jquery");
...
define("js/detail/dianping", [ "jquery", "js/common/util", "js/common/dialog", "js/common/CD" ], function(require, exports, module) {
    var $ = require("jquery");
