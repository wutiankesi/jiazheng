(function(window){
	...
	var document = win.document,
		ObjectPro = Object.prototype,
		ArrayPro = Array.prototype,
		toString = ObjectPro.toString,
		hasOwnProperty = ObjectPro.hasOwnProperty,
		trimLeft = /^\s+/,
		trimRight = /\s+$/;
   ...
   QEvent.prototype = {
	 	...
	 	*/
	 	triggerReady: function(name/* args */){
	...
	mix(QNR,{_config : {debug:true},
			 ...
			 isEmpty : function(obj) {
			  ...
			  subStr : function(str,maxlen,re){
					...
					for( var i=0,len=str.length; i<len ; i++ ){
						str.charCodeAt(i) >  127 ? n+=1 : n+=0.5;
						if(n > maxlen){
							ismuch = true;
							break;
						}
		...
		Q.loadModule = function(m_name,callback,_MODULES){
            ...
            var _load = function(){
                if(!loadedModules[m_name]){
                    loadedModules[m_name] = {status:LOADING,callbacks:[]};
